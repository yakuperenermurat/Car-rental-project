...
public class AdminView extends Layout {
    ...
    private JButton btn_seacrh_model;
    ...
    private JComboBox cmd_book_car;
    ...
    public void loadBookCompenent() {
        ...
        tableRowSelected(this.tbl_book, book_menu);

        btn_book_search.addActionListener(e -> {
            ComboItem selectedCar = (ComboItem) this.cmd_book_car.getSelectedItem();
            int carId = 0;
            if (selectedCar != null) {
    ...
    public void loadBookFilterCar(){
        this.cmd_book_car.removeAllItems();
        for (Car obj : this.carManager.findAll()){
            this.cmd_book_car.addItem(new ComboItem(obj.getId(),obj.getPlate()));
        }
        this.cmd_book_car.setSelectedItem(null);
    }
    ...
    public void loadBookingCompenent(){
        this.booking_menu = new JPopupMenu();
        this.booking_menu.add("Rezervsyon Yap").addActionListener(e -> {
    ...
    private void loadCarCompenent(){
        ...
        tableRowSelected(this.tbl_car, car_menu);
    }
    ...
    private void loadModelComponent() {
        ...
        tableRowSelected(this.tbl_model, model_menu);

        this.btn_seacrh_model.addActionListener(e -> {
    ...
    public void loadBrandComponent() {
        ...
        tableRowSelected(this.tbl_brand, brand_menu);
    }
