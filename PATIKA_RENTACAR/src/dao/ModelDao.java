...
public class ModelDao {
    ...
    // Tüm modelleri veritabanından çeken metot
    ...
    // Parametre olarak verilen SQL sorgusunu çalıştıran ve sonuçları döndüren metot
    ...
    // ResultSet'i Model nesnesine dönüştüren metot
